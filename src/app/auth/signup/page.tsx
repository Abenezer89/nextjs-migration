              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-start space-x-2 pt-2">
                  ...
                  <div className="space-y-1 leading-none">
                    ...
                    >
                      I agree to the <Link href="/terms" className="text-job-primary hover:underline">Terms of Service</Link> and <Link href="/privacy" className="text-job-primary hover:underline">Privacy Policy</Link>
                    </Label>
                    {errors.agreeTerms && (
            ...
            <CardFooter className="border-t pt-4 flex flex-col space-y-4">
              ...
              <div className="text-center mt-4">
                <p className="text-sm text-gray-600">
                  ...
                  <Link href="/login" className="text-job-primary hover:underline font-medium">
                    Sign in
                  </Link>
                </p>
              </div>

...
const JobPostSuccess: React.FC = () => {
  const jobUrl = "https://eshijobs.com/job/12345"; // This should be replaced with actual job URL
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            <Card>
              ...
              <CardFooter>
                <Link href="/employer/jobs/1/applicants">
          ...
          <div className="bg-blue-50 rounded-lg p-6 flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            <Link href="/employer/jobs/1/promote">

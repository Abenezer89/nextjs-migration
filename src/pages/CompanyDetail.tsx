  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-6 md:py-10">
        <Link to="/companies" className="inline-flex items-center text-gray-600 hover:text-job-primary mb-6 group">
          ...
          <TabsContent value="reviews" className="bg-white rounded-lg border border-gray-200 p-6 md:p-8 animate-fade-in">
            ...
            <div className="space-y-6">
              <div className="p-4 border border-gray-200 rounded-lg">
                ...
                <div className="text-sm text-gray-500 mb-3">Full-time • 2+ years • San Francisco, CA</div>
                <p className="text-gray-700 mb-2">
                  "Great work environment with talented colleagues. Interesting projects and good work-life balance. Management is supportive and transparent."
                </p>
                <div className="flex justify-between items-center mt-4 text-sm">
                  <div className="text-gray-500">Posted 2 months ago</div>
                  <Button variant="ghost" size="sm" className="text-gray-500 hover:text-job-primary">Helpful</Button>
                </div>
              </div>
              ...
              <div className="p-4 border border-gray-200 rounded-lg">
                ...
                <div className="text-sm text-gray-500 mb-3">Full-time • 1+ years • Remote</div>
                <p className="text-gray-700 mb-2">
                  "Excellent company culture that truly values employee input. Leadership is strong and the benefits are competitive. I've grown tremendously in my role."
                </p>
                <div className="flex justify-between items-center mt-4 text-sm">
                  <div className="text-gray-500">Posted 1 month ago</div>
                  <Button variant="ghost" size="sm" className="text-gray-500 hover:text-job-primary">Helpful</Button>
                </div>
              </div>
            </div>

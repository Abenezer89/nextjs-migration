          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  {showSalary && (
                    <>
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg">
                        <h3 className="font-medium mb-2">Salary Display Preview</h3>
                        <div className="text-lg font-medium text-job-primary">
                          {salaryCurrency === 'USD' ? '$' : salaryCurrency + ' '}
                          {salaryMin ? parseInt(salaryMin).toLocaleString() : '0'} - {salaryCurrency === 'USD' ? '$' : salaryCurrency + ' '}
                          {salaryMax ? parseInt(salaryMax).toLocaleString() : '0'} {salaryPeriod === 'yearly' ? 'a year' : salaryPeriod === 'monthly' ? 'a month' : 'an hour'}
                        </div>
                      </div>
                    </>
                  )}
            ...
            <div>
              <div className="bg-white rounded-lg border border-gray-200 p-6 sticky top-20">
                <h3 className="font-semibold mb-4">Compensation Tips</h3>
                
                <Alert className="bg-blue-50 border-blue-200 mb-4">
                  <InfoIcon className="h-4 w-4 text-blue-600" />
                  <AlertDescription className="text-blue-700">
                    Job posts with salary ranges get up to 50% more qualified applicants.
                  </AlertDescription>
                </Alert>
                
                <div className="space-y-4 mt-4">
                  <div>
                    <h4 className="font-medium">Why Show Salary?</h4>
                    <ul className="list-disc pl-5 mt-2 text-sm text-gray-600 space-y-1">
                      <li>Attracts more qualified candidates</li>
                      <li>Saves time by setting expectations early</li>
                      <li>Demonstrates transparency</li>
                      <li>Improves candidate experience</li>
                    </ul>
                  </div>
                  
                  <div>
                    <h4 className="font-medium">Popular Benefits</h4>
                    <ul className="list-disc pl-5 mt-2 text-sm text-gray-600 space-y-1">
